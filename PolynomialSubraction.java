...
public class PolynomialSubraction{
	public PolyNode subPolynomial(PolyNode poly1,PolyNode poly2){
		...
		while(poly1!=null&&poly2!=null){
			if(poly1.exponent>poly2.exponent){
				...
				int sub=poly1.values-poly2.values;
				if(sub!=0){
					current.next=new PolyNode(sub,poly1.exponent);
				}
				poly1=poly1.next;
				poly2=poly2.next;
			}
	...
	public static void main(String[] args){
		PolynomialSubraction pa=new PolynomialSubraction();
		...
		PolyNode result=pa.subPolynomial(poly1,poly2);
